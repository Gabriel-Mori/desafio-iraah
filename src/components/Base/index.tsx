...
const Base: React.FC<Props> = ({ children }) => {
  ...
  return (
    <div className="flex flex-col h-screen">
      <div className="bg-white dark:bg-intensive-black">
        <div className="container mx-auto md:p-0 px-5 w-screen">
          <header className="flex flex-col xl:flex-row items-center  justify-between py-4 ">
            <div className="flex">
              <div className="flex flex-col xl:flex-row justify-between w-full md:w-auto"></div>
                ...
                >
                  {showOptions && (
                    <>
                      ...
                      ></div>
                      <ul className="absolute top-8 w-36 bg-white overflow-hidden dark:bg-intensive-black text-gray-900 dark:text-white border border-gray-400 rounded-md">
                        <li
                        ...
                        >
                          Sair
                          <SignOut className="text-red-400" size={22} />
                        </li>
                      </ul>
                    </>
                  )}
